...
pub contract ExampleNFT: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT {
        ...
        init(initID: UInt64, metadata: ExampleNFT.Metadata, url: String) {
            self.id = initID
    ...
    pub resource NFTMinter {
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, metadata: ExampleNFT.Metadata, url: String) {
